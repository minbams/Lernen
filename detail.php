    ...
    <header id="home">
        ...
        <section id="blog-single" class="p-top-80 p-bottom-80">
            ...
            <div class="container clearfix">
                <div class="row">
                    ...
                    <div class="col-sm-6 sidebar">
                        ...
                        <div class="widget" style="margin-bottom: 20px;">
                            <ul>
                                <h4><?=$row['subject']?></h4>
                                <p><?=$row['coursename']?></p>
                                <p>Price <span style="color: #ff3946;"><?=$row['price']?></span> Baht</p>
                                <p><?=$row['length']?></p>
                            </ul>
                        </div>
                        <!--End widget-->
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="postSingle">
                            <div class="postMedia">
                                <img alt="" src="images/<?=$row['image']?>" width="500" height="300"
                ...
                <div class="hero-btns contact-btn" style="margin-top:50px; margin-bottom: 60px; widht: 50px;">
                                    <a href="payment.php?id=<?=$row['id_course']?>">PURCHASE</a>
            </div> <!-- /.container -->
        </section>
